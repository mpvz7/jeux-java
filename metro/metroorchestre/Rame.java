...
{
    /**
     * Enumératif permettant de gérer l'automate qui régit le fonctionnement
     * des rames
     */
    enum ETAT  
    { 
        ...
        /**
         * Le signal sonnore retenti et les portes de la rame sont en train 
         * de se fermer 
         */
        DEPART_IMMINENT, 
    ...
    /**
     * Declenche le processus de démarage de la rame...     
    ...
    /**
     * Declenche la sonnerie de la rame indiquant la fermeture des portes 
     ...
     * @throws RemoteException 
     */
    void actionnerMoteur(final int duree) 
